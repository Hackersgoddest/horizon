                ...
                <div className="flex flex-col gap-1 md:gap-3">
                    <h1 className="text-24 lg:text-36 font-semibold text-gray-900">
                        ...
                        <p className="text-16 font-normal text-gray-600">
                            {user ? 'Link your account to get started' : type === 'sign-in' ? 'Please enter your credentials to access your account' : 'Please enter your details to create an account'}
                        </p>
                    </h1>
                </div>
            </header>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-sm:space-y-6">
                            {type === 'sign-up' && (
                                <>
                                    ...
                                    <CustomInput control={form.control} name="address1" label="Address" placeholder="Specific address" />
